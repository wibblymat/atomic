...
Atomic.Graphics.Tilemap = function(tileset, width, height, tileWidth, tileHeight)
{
	...
	this.map = new Atomic.Space(this.columns, this.rows);
	this.canvas = document.createElement("canvas");
	this.canvas.width = width;
	this.canvas.height = height;
};
Atomic.Utils.extend(Atomic.Graphic, Atomic.Graphics.Tilemap);

Atomic.Graphics.Tilemap.prototype = {
...
Object.defineProperties( Atomic.Graphics.Tilemap.prototype,
{
});
